...
.inherits('Document')
.inherits('DocumentRange')
.protos({
    all:null, //< public [Node[]+NodeList]
    ...
    images:null, //< public [Image[]+HTMLCollection]
    implementation:null, //< public HTMLDOMImplementation
    ...
    styleSheets:null, //< public [CSSStyleSheet[]+StyleSheetList]
